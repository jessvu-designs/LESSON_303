...
export default function RootLayout() {
  // Explicitly load icon fonts. On web (Vercel), expo-font is what injects
  // the @font-face rule; without this, MaterialCommunityIcons renders as
  // blank/missing glyphs even though the .ttf is bundled.
